...
`velajs-mcp` 是一个 MCP Server，提供 Vela 快应用的知识库、编码规范和代码校验能力。配置后 AI 可自动调用其工具辅助开发调试。
...
项目代码生成完成后，可通过 velajs-mcp （https://www.npmjs.com/package/velajs-mcp）提供的 MCP 工具辅助开发。
